...
'''
#print(hashgen("UI_TT_ATMO_DRAGONMAGE_GOOD"))
#print(hashgen("UI_TT_ATMO_DRACHENMAGIER_GOOD"))
#print(hashgen("UI_TT_ATMO_DRAGONMAGE_BAD"))
#print(hashgen("UI_TT_ATMO_DRACHENMAGIER_BAD"))